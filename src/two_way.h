...
/* Perform a critical factorization of NEEDLE, of length NEEDLE_LEN.
   ...
   *PERIOD to the global period of the right half.
   ...
   periodicity.  */
static size_t FN_NAME(critical_factorization)(const unsigned char *needle, size_t needle_len,
                                              size_t *period) {
...
/* Return the first location of non-empty NEEDLE within HAYSTACK, or
   nullptr.  HAYSTACK_LEN is the minimum known length of HAYSTACK.  This
...
static RETURN_TYPE FN_NAME(two_way_short_needle)(const unsigned char *haystack, size_t haystack_len,
...
static RETURN_TYPE FN_NAME(two_way_long_needle)(const unsigned char *haystack, size_t haystack_len,
                                                const unsigned char *needle, size_t needle_len) {
    size_t i;                           /* Index into current byte of NEEDLE.  */
    size_t j;                           /* Index into current window of HAYSTACK.  */
    size_t period;                      /* The period of the right half of needle.  */
    ...
    for (i = 0; i < needle_len; i++) shift_table[CANON_ELEMENT(needle[i])] = needle_len - i - 1;
