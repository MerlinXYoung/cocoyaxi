...
inline bool cv_wait(cv_t* c, mutex_t* m, uint32 ms) {
...
static __thread bool g_done = false;
...
bool event::wait(uint32 ms) const { return god::cast<xx::event_impl*>(_p)->wait(ms); }
