...
__coapi void sha256_final(sha256_ctx_t* ctx, uint8_t res[32]);
...
inline fastring sha256digest(const char* s) { return sha256digest(s, strlen(s)); }

inline fastring sha256digest(const fastring& s) { return sha256digest(s.data(), s.size()); }

inline fastring sha256digest(const std::string& s) { return sha256digest(s.data(), s.size()); }
...
inline fastring sha256sum(const char* s) { return sha256sum(s, strlen(s)); }

inline fastring sha256sum(const fastring& s) { return sha256sum(s.data(), s.size()); }

inline fastring sha256sum(const std::string& s) { return sha256sum(s.data(), s.size()); }
