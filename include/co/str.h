...
__coapi fastring replace(const char* s, size_t n, const char* sub, size_t m, const char* to,
                         size_t l, size_t t = 0);
...
__coapi int32_t to_int32(const char* s);
__coapi int64_t to_int64(const char* s);
__coapi uint32_t to_uint32(const char* s);
__coapi uint64_t to_uint64(const char* s);
