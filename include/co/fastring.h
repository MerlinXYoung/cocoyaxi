...
class __coapi fastring : public fast::stream {
  public:
    ...
    fastring(size_t n, char c) : fast::stream(n + 1, n) { memset(_p, c, n); }

    fastring(char* p, size_t cap, size_t size) : fast::stream(p, cap, size) {}

    fastring(const void* s, size_t n) : fast::stream(n + !!n, n) { memcpy(_p, s, n); }
    ...
    fastring& operator=(fastring&& s) { return (fastring&)fast::stream::operator=(std::move(s)); }

    fastring& operator=(const fastring& s) {
        return &s != this ? this->_assign(s.data(), s.size()) : *this;
    }

    fastring& operator=(const std::string& s) { return this->_assign(s.data(), s.size()); }
    ...
    fastring& append(const void* p, size_t n) { return (fastring&)fast::stream::append(p, n); }
    ...
    fastring& append(const std::string& s) { return this->append_nomchk(s.data(), s.size()); }

    fastring& append(size_t n, char c) { return (fastring&)fast::stream::append(n, c); }
    ...
    fastring& operator+=(const char* s) { return this->append(s); }

    fastring& operator+=(char c) { return this->append(c); }
    ...
    fastring& operator<<(bool v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(char v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(signed char v) { return this->operator<<((char)v); }

    fastring& operator<<(unsigned char v) { return this->operator<<((char)v); }

    fastring& operator<<(short v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(unsigned short v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(int v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(unsigned int v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(long v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(unsigned long v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(long long v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(unsigned long long v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(double v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(float v) { return (fastring&)fast::stream::operator<<(v); }

    // float point number with max decimal places set
    //   - fastring() << dp::_2(3.1415);  // -> 3.14
    fastring& operator<<(const dp::_fpt& v) { return (fastring&)fast::stream::operator<<(v); }

    fastring& operator<<(const void* v) { return (fastring&)fast::stream::operator<<(v); }
    ...
    fastring& operator<<(const unsigned char* s) { return this->operator<<((const char*)s); }

    fastring& operator<<(const fastring& s) { return this->append(s); }

    fastring& operator<<(const std::string& s) { return this->append_nomchk(s.data(), s.size()); }

    int compare(const char* s, size_t n) const { return str::memcmp(_p, _size, s, n); }

    int compare(const char* s) const { return this->compare(s, strlen(s)); }

    int compare(const fastring& s) const noexcept { return this->compare(s.data(), s.size()); }

    int compare(const std::string& s) const noexcept { return this->compare(s.data(), s.size()); }
    ...
    bool contains(const std::string& s) const { return this->contains(s.c_str()); }

    bool starts_with(char c) const { return !this->empty() && this->front() == c; }

    bool starts_with(const char* s, size_t n) const {
        return n == 0 || (n <= _size && ::memcmp(_p, s, n) == 0);
    }

    bool starts_with(const char* s) const { return this->starts_with(s, strlen(s)); }

    bool starts_with(const fastring& s) const { return this->starts_with(s.data(), s.size()); }

    bool starts_with(const std::string& s) const { return this->starts_with(s.data(), s.size()); }
    ...
    bool ends_with(const fastring& s) const { return this->ends_with(s.data(), s.size()); }

    bool ends_with(const std::string& s) const { return this->ends_with(s.data(), s.size()); }

    fastring& remove_prefix(const char* s, size_t n) {
        return this->starts_with(s, n) ? this->trim(n, 'l') : *this;
    }

    fastring& remove_prefix(const char* s) { return this->remove_prefix(s, strlen(s)); }

    fastring& remove_prefix(const fastring& s) { return this->remove_prefix(s.data(), s.size()); }
    ...
    fastring& remove_suffix(const char* s) { return this->remove_suffix(s, strlen(s)); }

    fastring& remove_suffix(const fastring& s) { return this->remove_suffix(s.data(), s.size()); }
    ...
    fastring& trim(unsigned char c, char d = 'b') { return this->trim((char)c, d); }
    ...
    // find @s from @pos
    size_t find(const char* s, size_t pos) const { return this->find(s, pos, strlen(s)); }
    ...
    size_t ifind(const char* s, size_t pos) const { return this->ifind(s, pos, strlen(s)); }
    ...
    size_t ifind(char c, size_t pos = 0) const { return this->ifind(&c, pos, 1); }
    ...
    size_t rfind(const char* s, size_t pos) const { return this->rfind(s, pos, strlen(s)); }
...
inline bool operator==(const fastring& a, const fastring& b) { return a.compare(b) == 0; }

inline bool operator==(const fastring& a, const std::string& b) { return a.compare(b) == 0; }

inline bool operator==(const std::string& a, const fastring& b) { return b == a; }

inline bool operator==(const fastring& a, const char* b) { return a.compare(b) == 0; }

inline bool operator==(const char* a, const fastring& b) { return b == a; }

inline bool operator!=(const fastring& a, const fastring& b) { return !(a == b); }

inline bool operator!=(const fastring& a, const std::string& b) { return !(a == b); }

inline bool operator!=(const std::string& a, const fastring& b) { return !(a == b); }

inline bool operator!=(const fastring& a, const char* b) { return !(a == b); }
...
inline bool operator<(const std::string& a, const fastring& b) { return b.compare(a) > 0; }
...
struct hash<fastring> {
    size_t operator()(const fastring& s) const { return murmur_hash(s.data(), s.size()); }
};
}  // namespace std
